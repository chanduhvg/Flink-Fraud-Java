...
## Steps for Execution of String Length Fraud Detection
- Add flink dependencies in the pom.xml file to use flink methods in java code.
- Build the application to make sure all the dependencies are downloaded/added to the project.
- Before running the java main class(App.java),start the ncat server on port 9000.
- Java code written using flink stream methods to listen on port 9000.
...
server on port 9000
4. We need to give input number in ncat server in power shell command and check if number is greater than 1000 returns as  number and if the number is less than 1000 it returns as fraud number as over input.
...
## Steps for Execution of Suspicious String in Fraud Detection
- Add flink dependencies in the pom.xml file to use flink methods in java code.
- Build the application to make sure all the dependencies are downloaded/added to the project.
- Before running the java main class(App.java),start the ncat server on port 9000.
- Java code written using flink stream methods to listen on port 9000.
